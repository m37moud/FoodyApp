...
import com.example.foody.util.Constants.Companion.PREFERENCES_search_ONLINE
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private object PreferenceKeys {
        ...
        val doSearch = preferencesKey<Boolean>(PREFERENCES_search_ONLINE)
    ...
    suspend fun saveSearch(doSearch: Boolean) {
        dataStore.edit { preferences ->
            preferences[PreferenceKeys.doSearch] = doSearch
        }
    }
    ...
    val readSearch: Flow<Boolean> = dataStore.data
        .catch { exception ->
            if (exception is IOException) {
                emit(emptyPreferences())
            } else {
        ...
        .map { preferences ->
            val doSearch = preferences[PreferenceKeys.doSearch] ?: false
            doSearch
        }
